! function (s) {
    ...
    s.extend(t.prototype, {
        ...
        initSingle: function () {
            ...
            }).appendTo(t), e.addClass("active").css("opacity", 1), i.append(t).prependTo(this.$el), this.$el.addClass("zs-enabled"), "dots" == this.settings.overlay ? this.$el.addClass("overlay-dots") : "plain" == this.settings.overlay && this.$el.addClass("overlay-plain"), this.support && (e.css("opacity", 0).css(this.transitionProp), setTimeout(function () {
                e.css({
                    opacity: 1,
                    transform: "scale(1.0, 1.0)",
                    "z-index": 2
